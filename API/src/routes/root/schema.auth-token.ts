...
export const authTokenEndpoint: EndpointSchema = {
  ...
  response: {
    ...
    'confidential exchange errors':
      'A 403 carrying the public code TOKEN_EXCHANGE_SUBJECT_FORBIDDEN means the person’s own current state refuses the exchange (moved credential epoch, unknown user, lost source-domain role, or unavailable selected team) without saying which; ask them to sign in again. A 403 with the generic body and no code is the calling product’s own mapping, scope, or team-context configuration, decided before any subject lookup.',
