 ...
 * team's policy checks like any other card; Decline refreshes the chooser payload in place
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        >
          {submitting === 'accept' ? '...' : t('team.invite.accept')}
        </Button>
        <button
          type="button"
          disabled={props.disabled || busy}
        ...
        >
          {submitting === 'decline' ? '...' : t('team.invite.decline')}
        </button>
      </div>
    </div>
  );
