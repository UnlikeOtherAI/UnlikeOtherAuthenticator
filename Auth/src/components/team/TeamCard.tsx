...
import { submitTeamSelection } from '../../utils/team-actions.js';
import type { TeamResponseOutcome } from '../../utils/team-response.js';
import { teamAvatarColor, teamInitials } from '../../utils/team-icon.js';

/**
 * Phase 3c (design §11.2/§11.3): one ACTIVE team in the chooser. The whole card is the
 * button — clicking it selects that team. The image is the team avatar
 * (`/teams/:teamId/avatar`, Docs/Auth/avatars.md §11.3), with the deterministic initials-on-color
 * badge (`utils/team-icon.ts`) as the offline fallback.
 */
    ...
    >
      {imageUrl ? (
        ...
        <span
          ...
          style={{ backgroundColor: teamAvatarColor(props.team.teamId) }}
        >
