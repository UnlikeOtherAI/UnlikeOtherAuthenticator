/**
 * Deterministic team icon fallback (design §11.3): when a team/org has no `iconUrl`, every
 ...
 *   2. hue = hash % 360, fixed saturation 55% / lightness 45% (`teamAvatarColor`) — an
 ...
 *      (`teamInitials`); a single-word name uses its first two characters
 */
...
/** Up to two uppercase initials for a team/team name. */
