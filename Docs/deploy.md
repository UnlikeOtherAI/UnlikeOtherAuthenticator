...
| `SHARED_SECRET`                             | Secret Manager: `uoa-auth-shared-secret`; generate with `openssl rand -base64 48` — production refuses values shorter than 48 characters or with low entropy                                                                                                                                                                                                                                                                                                                                                                                                                          |
