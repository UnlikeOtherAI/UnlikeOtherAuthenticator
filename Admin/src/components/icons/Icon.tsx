...
const paths: Record<IconName, string[]> = {
  ...
  bug: ['M12 8a4 4 0 014 4v2a4 4 0 11-8 0v-2a4 4 0 014-4z', 'M9.5 8l-1.5-2M14.5 8l1.5-2', 'M8 12H4M20 12h-4M8 16l-3 2M16 16l3 2M12 8v8'],
  check: ['M5 13l4 4L19 7'],
  chevronRight: ['M9 5l7 7-7 7'],
  close: ['M6 18L18 6M6 6l12 12'],
  copy: ['M9 9h10a2 2 0 012 2v8a2 2 0 01-2 2H9a2 2 0 01-2-2v-8a2 2 0 012-2z', 'M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1'],
