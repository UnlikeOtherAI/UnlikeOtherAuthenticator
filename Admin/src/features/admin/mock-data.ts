...
export const mockAdminData: AdminData = {
  ...
  handshakeErrors: [
    handshakeError(
      ...
      'Config JWT signature did not match the domain shared secret.',
      ['The JWT was signed with a key that does not match widgets.io.', 'The auth_service_identifier claim matched, so this is most likely an environment secret mismatch.'],
      [],
      { alg: 'HS256', typ: 'JWT', kid: 'widgets-prod' },
      {
        domain: 'widgets.io',
        app_identifier: 'io.widgets.dashboard',
        auth_service_identifier: 'uoa-prod',
    ...
    handshakeError(
      ...
      { alg: 'HS256', typ: 'JWT', kid: 'acme-staging' },
      {
        domain: 'app.acme.com',
    ...
    handshakeError(
      ...
      [],
      { alg: 'HS256', typ: 'JWT', kid: 'startup-dev' },
      {
